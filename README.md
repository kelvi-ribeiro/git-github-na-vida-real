...
| `git rev-list --all --count` | Comando para visualizar o número de commits de todas as branchs, nota-se que se for desejado ver número de commits de apenas uma branch, é só trocar o parâmetro --all pela branch desejada.
